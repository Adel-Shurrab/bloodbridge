                ...
                <div class="privacy-content">
                    ...
                    <div class="content-block" id="data-usage">
                        ...
                        <ul>
                            ...
                            <li><strong>الإشعارات الطارئة:</strong> إرسال تنبيهات فورية عند وجود حاجة ماسة لدم في منطقتك
                            </li>
                    ...
                    <div class="content-block" id="retention">
                        ...
                        <ul>
                            ...
                            <li><strong>السجلات الطبية:</strong> يتم الاحتفاظ بها وفقاً للقوانين الطبية (عادة 5-10
                                سنوات)</li>
                    ...
                    <div class="content-block">
                        <h2>📝 شروط إضافية</h2>
                        <ul>
                            <li>قد تتغير هذه السياسة من وقت لآخر. سيتم إخطارك بأي تغييرات جوهرية عبر البريد الإلكتروني
                            </li>
