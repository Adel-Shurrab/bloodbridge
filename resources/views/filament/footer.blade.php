    ...
    <div class="bb-footer-card">
        ...
        <div class="bb-footer-top">
            <div class="bb-footer-brand">
                <img src="{{ $logo }}" alt="{{ $siteName }}" class="bb-footer-logo">
                <span class="bb-footer-name">{{ $siteName }}</span>
            </div>
        ...
        <p class="bb-footer-copy">
            &copy; {{ date('Y') }} <strong>{{ $siteName }}</strong>. {{ __('All rights reserved.') }}
        </p>
