                ...
                <form id="donorRegistrationForm" method="POST" action="{{ route('register.donor.store') }}">
                    ...
                    <div class="form-step active" id="step1">
                            ...
                            <div class="form-group full-width">
                                ...
                                <div style="position: relative; display: flex; gap: 0.5rem;">
                                    <input type="text" id="auto_location_address" name="auto_location_address"
                                        ...
                                        placeholder="اضغط على زر الموقع لتحديد موقعك تلقائياً" readonly
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="password_confirmation">تأكيد كلمة السر <span
                    ...
                    <div class="form-step" id="step2">
                        ...
                        <div style="margin-bottom: 2rem;">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <span class="helper-text">يجب أن يكون {{ $settings->min_donor_weight }} كغ على
                                        الأقل</span>
                                    <span class="error-message"></span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="helper-text">يجب أن يكون {{ $settings->min_donor_height }} سم على
                                        الأقل</span>
                                    <span class="error-message"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group full-width">
                                    ...
                                    <span class="helper-text">سيقوم المستشفى بإجراء فحص للتأكد من الفصيلة عند
                                        التبرع</span>
                                    <span class="error-message"></span>
                                </div>
                            </div>
                        ...
                        <div style="margin-bottom: 2rem;">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="recent_donation">هل قمت بالتبرع بالدم سابقاً؟ <span
                                            class="required">*</span></label>
                                ...
                                <div class="form-group" id="last_donation_date_container" style="display: none;">
                                    <label for="last_donation_date">تاريخ آخر تبرع <span
                                            class="required">*</span></label>
                                    ...
                                    <span class="helper-text">يجب الانتظار {{ $settings->min_days_between_donations }}
                                        يوم بين
                                        التبرعات</span>
                                    <span class="error-message"></span>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="has_recent_surgery" name="has_recent_surgery" required>
                                        <option value="" disabled selected>اختر الإجابة</option>
                                        <option value="1"
                                            {{ old('has_recent_surgery') == '1' ? 'selected' : '' }}>نعم</option>
                                        <option value="0"
                                            {{ old('has_recent_surgery') == '0' ? 'selected' : '' }}>لا</option>
                                    </select>
                                    <span class="error-message"></span>
                                </div>

                                <div class="form-group" id="surgery_date_container" style="display: none;">
                                    <label for="surgery_date">تاريخ آخر عملية جراحية <span
                                            class="required">*</span></label>
                                    <div class="date-input-wrapper" style="position: relative;">
                                    ...
                                    <span class="helper-text">يجب الانتظار {{ $settings->min_days_after_surgery }} يوم
                                        بعد العملية</span>
                                    <span class="error-message"></span>
                                </div>
                            </div>
                                ...
                                <div style="display: flex; align-items: flex-start; gap: 1rem;">
                                    ...
                                    <div class="info-content" style="flex: 1;">
                                        <strong id="eligibility-review-title"
                                            style="font-size: 1.1rem; display: block; margin-bottom: 0.5rem;">حالة
                                            التأهيل</strong>
                            ...
                            <div class="info-box" style="background: #f3f4f6; border-color: #d1d5db;">
                                ...
                                <div class="info-content">
                                    ...
                                    <p style="margin: 0.5rem 0 0 0; line-height: 1.6;">
                                        ...
                                        <br>
                                        يمكنك تحديث معلوماتك الإضافية (زمرة الدم والمزيد) لاحقاً من لوحة التحكم الخاصة
                                        بك.
                                    </p>
                                </div>
                            </div>
                                ...
                                <label class="checkbox-label"
                                    ...
                                    <span class="checkbox-text" style="padding: 0;">
                                        ...
                                        <a href="{{ route('terms') }}" target="_blank" class="terms-link"
                                            style="color: #dc2626; text-decoration: underline;">شروط الخدمة</a>
                                        و <a href="javascript:void(0)"
                                            @click.prevent="$dispatch('open-modal', 'privacyModal')"
                                            class="terms-link"
                                            style="color: #dc2626; text-decoration: underline;">سياسة الخصوصية</a>
                ...
                <div class="modal-overlay" id="ineligibleModal">
                    <div class="modal-content">
                        ...
                        <p>
                            ...
                            <br><br>
                            بناءً على المعلومات الصحية المقدمة (وجود أمراض مزمنة)، وحرصاً منا على سلامتك الشخصية أولاً،
                            لا يمكننا قبول
