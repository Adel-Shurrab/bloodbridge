            ...
            <div class="footer-section">
                ...
                <ul>
                    ...
                    <li><a href="javascript:void(0)" @click.prevent="$dispatch('open-modal', 'privacyModal')">سياسة
                            الخصوصية</a></li>
                    <li><a href="{{ route('terms') }}">شروط الخدمة</a></li>
                </ul>
            </div>
            ...
            <div class="footer-section">
                ...
                <ul>
                    ...
                    <li><a href="javascript:void(0)"
                            @click.prevent="$dispatch('open-modal', 'eligibilityModal')">متطلبات الأهلية</a></li>
                    <li><a href="{{ route('contact') }}#faq">الأسئلة الشائعة</a></li>
                </ul>
            </div>
