...
return [
    ...
    'boolean' => 'حقل :attribute يجب أن يكون صحيحاً (True) أو خطأ (False).', // <-- هذا السطر سيحل مشكلة الخطأ
    ...
    'unique' => ':attribute مسجل لدينا بالفعل.', // تم تحسين الترجمة لتكون أوضح للمستخدم
