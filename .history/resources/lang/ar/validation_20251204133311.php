...
return [
    ...
    */
    ...
    'exists'               => ':attribute غير موجود في قاعدة بياناتنا.',
    'file'                 => ':attribute يجب أن يكون ملفًا.',
    'filled'               => ':attribute مطلوب ولا يمكن أن يكون فارغًا.',
    'gt'                   => [
    ...
    'required_unless'      => ':attribute مطلوب إلا إذا كان :other يساوي :values.',
    ...
    'size'                 => [
        ...
        'string'  => 'يجب أن يكون طول النّص :attribute :size حروفًا.',
    ...
    'unique'               => ':attribute مستخدم بالفعل. يرجى اختيار قيمة أخرى.',
    ...
    |--------------------------------------------------------------------------
    |
    | This array allows you to replace the attribute name with a friendly Arabic name.
    */
