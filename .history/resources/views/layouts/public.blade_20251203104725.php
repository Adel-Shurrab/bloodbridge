...
<head>
    ...
    <meta name="description" content="{{ $description ?? 'BloodBridge - نظام ذكي يربط المتبرعين بالمحتاجين. تبرع بالدم وأنقذ الأرواح اليوم.' }}" />
    ...
    <link rel="shortcut icon" type="image/jpeg" href="{{ asset('assets/images/favicon.jpg') }}" />
