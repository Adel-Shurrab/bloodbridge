        ...
        @foreach($stats as $stat)
            <div
                ...
                <div class="flex items-start justify-between">
                    ...
                    {{-- Icon (Right in RTL) --}}
                    <div class="{{ $stat['bg'] }} dark:bg-opacity-20 p-4 rounded-2xl w-16 h-16 flex items-center justify-center shrink-0 shadow-inner">
                        <div class="w-8 h-8 flex items-center justify-center">
                            @svg($stat['icon'], 'w-full h-full ' . $stat['color'])
                        </div>
                    </div>
                </div>
