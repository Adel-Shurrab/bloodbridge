<x-filament-widgets::widget>
    <div class="custom-stats-grid">
        @foreach($stats as $stat)
            @php
                $accentColor = str_contains($stat['color'], 'red') ? 'rgba(239, 68, 68, 0.2)' : 
                              (str_contains($stat['color'], 'blue') ? 'rgba(37, 99, 235, 0.2)' : 
                              (str_contains($stat['color'], 'emerald') ? 'rgba(16, 185, 129, 0.2)' : 
                               'rgba(219, 39, 119, 0.2)'));
            @endphp
            <div class="stat-card" style="border-bottom: 4px solid {{ $accentColor }};">
                <div class="stat-top">
