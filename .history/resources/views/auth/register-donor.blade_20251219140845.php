<x-layout title="تسجيل متبرع جديد - BloodBridge">
  ...
  <section class="registration-donor-section">
    ...
    <div class="date-input-wrapper" style="position: relative;">
        <input type="date" id="last_donation_date" name="last_donation_date" max="{{ date('Y-m-d') }}" style="width: 100%;" />
        
        <button type="button" class="clear-date-btn" data-target="last_donation_date" style="display: none;">
            ✕
        </button>
    </div>
...
<div class="form-group">
    ...
    <div class="date-input-wrapper" style="position: relative;">
        <input type="date" id="surgery_date" name="surgery_date" max="{{ date('Y-m-d') }}" style="width: 100%;" />
