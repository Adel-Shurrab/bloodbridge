<x-layout title="تسجيل منظمة جديدة - BloodBridge">
    ...
    <section class="registration-organization-section">
        <div class="registration-container">
            ...
            <div class="form-container">
                ...
                <form id="organizationRegistrationForm" method="POST" action="{{ route('register.organization.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-step active" id="step1">
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                ...
                                <input type="text" id="organizationName" name="organizationName" value="{{ old('organizationName') }}" required placeholder="مستشفى المجتمع العام" />
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                ...
                                <textarea id="organizationDescription" name="organizationDescription" rows="4" placeholder="قم بوصف دور مؤسستك بشكل موجز">{{ old('organizationDescription') }}</textarea>
                    ...
                    <div class="form-step" id="step2">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="contactEmail">البريد الإلكتروني للتواصل <span class="required">*</span></label>
                                <input type="email" id="contactEmail" name="contactEmail" value="{{ old('contactEmail') }}" required placeholder="contact@organization.com" />
                                <span class="error-message"></span>
                            </div>

                            <div class="form-group">
                                <label for="contactPhone">رقم الجوال للتواصل <span class="required">*</span></label>
                                <input type="tel" id="contactPhone" name="contactPhone" value="{{ old('contactPhone') }}" required placeholder="0599xxxxxx" />
                                <span class="error-message"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                ...
                                <input type="text" id="streetAddress" name="streetAddress" value="{{ old('streetAddress') }}" required placeholder="123 الشارع الرئيسي" />
                                <span class="error-message"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="city" name="city" value="{{ old('city') }}" required placeholder="غزة" />
                                <span class="error-message"></span>
                            </div>

                            <div class="form-group">
                                <label for="state">المحافظة/الولاية <span class="required">*</span></label>
                                <input type="text" id="state" name="state" value="{{ old('state') }}" required placeholder="قطاع غزة" />
                                <span class="error-message"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="postalCode" name="postalCode" value="{{ old('postalCode') }}" placeholder="12345" />
                                <span class="error-message"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-step" id="step3">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="licenseNumber" name="licenseNumber" value="{{ old('licenseNumber') }}" required placeholder="LIC-123456789" />
                                <span class="error-message"></span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-upload-wrapper">
                                    <input type="file" id="licenseUpload" name="licenseUpload" accept=".pdf,.jpg,.jpeg,.png" required class="file-input" />
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="adminName" name="adminName" value="{{ old('adminName') }}" required placeholder="أحمد محمد" />
                                <span class="error-message"></span>
                            </div>

                            <div class="form-group">
                                <label for="adminEmail">البريد الإلكتروني للمسؤول <span class="required">*</span></label>
                                <input type="email" id="adminEmail" name="adminEmail" value="{{ old('adminEmail') }}" required placeholder="admin@organization.com" />
                                <span class="error-message"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="adminPassword_confirmation">تأكيد كلمة السر <span class="required">*</span></label>
                                <div class="password-input">
                                    <input type="password" id="adminPassword_confirmation" name="adminPassword_confirmation" required placeholder="••••••••" />
                    ...
                    <div class="form-step" id="step4">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-content">
                                ...
                                <p>سيتم مراجعة طلبك من قبل فريقنا. سنرسل لك بريداً إلكترونياً بمجرد تفعيل حسابك بالكامل.</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group checkbox-group">
                            <label class="checkbox-label">
                                ...
                                <span class="checkbox-text">لقد قرأت ووافقت على <a href="#" class="terms-link">الشروط والأحكام</a> <span class="required">*</span></span>
                            </label>
                            <span class="error-message"></span>
                        </div>
                    </div>
    ...
    @push('scripts')
        ...
        <script>
            // هذا الكود يتجاوز التحقق من حقل النوع المحذوف لمنع حدوث أخطاء
