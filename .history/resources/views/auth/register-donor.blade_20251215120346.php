  ...
  <section class="registration-donor-section">
        ...
        <form id="donorRegistrationForm" method="POST" action="{{ route('register.donor.store') }}">
          ...
          <div class="form-step" id="step2">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                <label class="checkbox-label">
                  <input type="checkbox" id="is_smoker" name="is_smoker" value="1"/>
                  <span class="checkbox-custom"></span>
            ...
            <div class="form-row">
              <div class="form-group">
                <label class="checkbox-label">
                  <input type="checkbox" id="recent_donation" name="recent_donation" value="1"/>
                  <span class="checkbox-custom"></span>
            ...
            <div class="form-row">
              <div class="form-group">
                <label class="checkbox-label">
                  <input type="checkbox" id="has_recent_surgery" name="has_recent_surgery" value="1"/>
                  <span class="checkbox-custom"></span>
    ...
    <div class="modal-content">
        ...
        <p>
            ...
            <br><br>
            بناءً على المعلومات الصحية المقدمة (وجود أمراض مزمنة)، وحرصاً منا على سلامتك الشخصية أولاً، لا يمكننا قبول تسجيلك كمتبرع في الوقت الحالي.
            <br><br>
