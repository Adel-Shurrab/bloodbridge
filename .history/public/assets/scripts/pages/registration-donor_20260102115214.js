...
const weightVal = weightField ? weightField.value : '';
const heightVal = heightField ? heightField.value : '';
...
// 1. Basic Checks
// Only check weight/height if values are explicitly entered
...
if (lastDonationInput && lastDonationInput.validity.badInput) {
    isEligible = false;
    ineligibilityReasons.push('تاريخ التبرع السابق غير مكتمل');
}

if (surgeryInput && surgeryInput.validity.badInput) {
    isEligible = false;
