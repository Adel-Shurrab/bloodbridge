  ...
  continueBtn.addEventListener('click', (e) => {
    ...
    setTimeout(() => {
      if (selectedOption === 'donor') {
        window.location.href = continueBtn.getAttribute('data-donor-url') || '/register_selection/donor';
      } else if (selectedOption === 'organization') {
        window.location.href = continueBtn.getAttribute('data-org-url') || '/register_selection/organization';
      }
    }, 600);
  });
}
