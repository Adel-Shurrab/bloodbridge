...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Display server-side validation errors under fields
    if (typeof window.serverErrors !== 'undefined' && window.serverErrors) {
        Object.keys(window.serverErrors).forEach(fieldId => {
            const message = window.serverErrors[fieldId];
