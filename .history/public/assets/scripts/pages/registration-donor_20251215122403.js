...
function initNavigation() {
    ...
    submitBtn.addEventListener('click', function (e) {
        ...
        // Check if permanently ineligible
        if (formData.isPermanentlyIneligible) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize ineligible modal close functionality
    const ineligibleModal = document.getElementById('ineligibleModal');
    if (ineligibleModal) {
        // Close modal when clicking outside of it
        ineligibleModal.addEventListener('click', (e) => {
            if (e.target === ineligibleModal) {
                ineligibleModal.style.display = 'none';
            }
        });
    }
