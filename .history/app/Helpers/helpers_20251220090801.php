...
if (!function_exists('trans_const')) {
     ...
     * 
     * @example
     * trans_const('constants.blood_request_status.pending') // Returns 'قيد الانتظار' (if locale is 'ar')
     * trans_const('constants.gender.male') // Returns 'ذكر'
     * trans_const('constants.user_roles.donor') // Returns 'متبرع'
     */
