...
class ManageGeneralSettings extends SettingsPage
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->schema([
                Schemas\Components\Section::make('Site Configuration')
                    ->schema([
                        Schemas\Components\TextInput::make('site_name')
                            ->label('Website Name')
                            ->required(),
                        Schemas\Components\Toggle::make('site_active')
                            ->label('Enable Website Access')
                            ->helperText('Turn this off to put the site in maintenance mode.'),
                    ]),
                Schemas\Components\Section::make('Content & Contact')
                    ->schema([
