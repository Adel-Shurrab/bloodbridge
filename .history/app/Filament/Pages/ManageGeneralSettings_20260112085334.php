...
class ManageGeneralSettings extends SettingsPage
{
    ...
    {
        try {
            \Illuminate\Support\Facades\Log::info('ManageGeneralSettings: Saving settings...');
            parent::save();
            \Illuminate\Support\Facades\Log::info('ManageGeneralSettings: Settings saved successfully.');
        } catch (\Exception $e) {
            \Illuminate\Support\Facades\Log::error('ManageGeneralSettings: Save failed - ' . $e->getMessage());
            throw $e;
        }
    }
}
