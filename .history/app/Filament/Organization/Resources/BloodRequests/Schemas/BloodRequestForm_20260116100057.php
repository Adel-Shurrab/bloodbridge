                        ...
                        Section::make('Basic Information')
                            ...
                            ->schema([
                                ...
                                Select::make('blood_type')
                                    ...
                                    ->options(BloodRequest::getBloodTypeOptions())
                                    ->required()
                                    ->native(false),
                            ...
                            ->schema([
                                ...
                                Map::make('location')
                                    ...
                                    ->afterStateUpdated(function (Get $get, $state) {
                                        // Logic to save lat/lng separately if needed, 
                                        // but map picker often saves as JSON or array.
                                        // We will need to Cast this in the Model.
                                    }),
                            ]),
                    ]),
            ]);
