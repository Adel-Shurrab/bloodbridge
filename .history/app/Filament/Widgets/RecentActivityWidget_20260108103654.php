...
class RecentActivityWidget extends Widget
{
    ...
    public function getActivities(): array
    {
        ...
        \App\Models\BloodRequest::latest()->take(3)->get()->each(function ($request) use ($activities) {
            $activities->push([
                'title' => "تم إنشاء طلب تبرع جديد لـ {$request->blood_type}.",
        ...
        // Latest Donors
        \App\Models\Donor::latest()->take(3)->get()->each(function ($donor) use ($activities) {
            $activities->push([
