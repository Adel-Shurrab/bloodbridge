...
class RecentActivityWidget extends Widget
{
    ...
    public function getActivities(): array
    {
        ...
        \App\Models\BloodRequest::latest()->take($this->limit + 5)->get()->each(function ($request) use ($activities, $bloodTypeOptions) {
        ...
        // Latest Donors
        \App\Models\Donor::latest()->take($this->limit + 5)->get()->each(function ($donor) use ($activities) {
            $activities->push([
        ...
        return $activities->sortByDesc('timestamp')->take($this->limit)->toArray();
    }
}
