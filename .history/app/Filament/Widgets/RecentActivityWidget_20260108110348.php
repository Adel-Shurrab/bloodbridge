...
class RecentActivityWidget extends Widget
{
    ...
    public function getActivities(): array
    {
        ...
        \App\Models\BloodRequest::latest()->take(10)->get()->each(function ($request) use ($activities, $bloodTypeOptions) {
        ...
        // Latest Donors
        \App\Models\Donor::latest()->take(10)->get()->each(function ($donor) use ($activities) {
            $activities->push([
        ...
        return $activities->sortByDesc('timestamp')->take(10)->toArray();
    }
}
