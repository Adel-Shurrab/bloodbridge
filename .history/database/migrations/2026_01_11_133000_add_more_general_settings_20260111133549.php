...
return new class extends SettingsMigration
{
    ...
    {
        // Identity & System
        // site_name and site_active already exist in previous migration
        // $this->migrator->update('general.site_name', 'BloodBridge'); // No change needed but can update if wanted
        $this->migrator->add('general.site_slogan', 'أعط الحياة قطرة قطرة');
        // $this->migrator->update('general.site_active', true);
        ...
        // Contact Info (Exact from settings.html)
        // support_email already exists, lets update it to the value from settings.html
        ...
        // Home Page Content (Exact from settings.html)
        ...
        // About Page (Exact from settings.html)
        ...
        // Contact Page (Exact from settings.html)
        ...
        // Auth Pages (Exact from settings.html)
        ...
        // main_content exists in previous migration
