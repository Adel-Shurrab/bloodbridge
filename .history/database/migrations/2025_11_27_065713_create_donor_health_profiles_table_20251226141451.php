...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('donor_health_profiles', function (Blueprint $table) {
            ...
            $table->enum('blood_type', Donor::BLOOD_TYPES_LIST)->index()->nullable()->comment('Self declared');
            $table->enum('verified_blood_type', Donor::BLOOD_TYPES_LIST)->nullable()->comment('Hospital verified');
