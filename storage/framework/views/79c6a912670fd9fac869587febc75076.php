...
<div x-data="{
    ...
    style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 2000; display: <?php echo e($show ? 'flex' : 'none'); ?>; align-items: center; justify-content: center; backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px);">
    ...
    <div x-show="show"
        class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?>"
...
<?php /**PATH C:\Users\adels\Herd\bloodbridge\resources\views\components\modal.blade.php ENDPATH**/ ?>